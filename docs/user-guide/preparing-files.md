...
The pipeline is controlled by editing configuration and manifest files. Defaults are found in the `nextflow.config` file, within the /test folder.
...
### Starting from aligned .h5 files
