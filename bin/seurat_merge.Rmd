...
params:
  species: "hg19"
  samplesheet: "/data/CCBR_Pipeliner/Pipelines/TechDev_scRNASeq_Dev2023/SINCLAIR/assets/input_manifest_cellranger.csv"
  rdsFiles: "/data/sevillas2/scRNA_test/seurat/preprocess/sample2_seurat_preprocess.rds /data/sevillas2/scRNA_test/seurat/preprocess/sample4_seurat_preprocess.rds"
  gid: "group1-group2"
...
for (p in readObj){
  ...
  combinedObj.list[[p]]$Group = subset(samplesheet_df,uniqueID==strsplit(names(combinedObj.list)[1],"_")[[1]][2])$groupID
  i <- i + 1
 }
```
