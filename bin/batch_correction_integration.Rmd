...
params:
  ...
  ccaObj: "/data/sevillas2/scRNA_test/batch_correct/group1-group2_batch_correction_cca.rds"
  rpcaObj: "/data/sevillas2/scRNA_test/batch_correct/group1-group2_batch_correction_rpca.rds"
  harmonyObj: "/data/sevillas2/scRNA_test/batch_correct/group1-group2_batch_correction_harmony.rds"
  scviObj: "/data/sevillas2/scRNA_test/batch_correct/group1-group2_batch_correction_scvi.rds"
  ligerObj: "/data/sevillas2/scRNA_test/batch_correct/group1-group2_batch_correction_liger.rds"
  resolution_list: "0.1,0.2,0.3,0.5,0.6,0.8,1"
  citeseq: "text"
  annot: "text"
  npcs: "20"
  Rlib_dir: "/data/CCBR_Pipeliner/db/PipeDB/Rlibrary_4.3_scRNA_RHEL8"
  Rpkg_config: "/data/CCBR_Pipeliner/Pipelines/SINCLAIR/SINCLAIR/conf/Rpack.config"
  scRNA_functions: "/data/CCBR_Pipeliner/Pipelines/SINCLAIR/SINCLAIR/bin/scRNA_functions.R"
  testing: "Y"
---
...
so_merged <- ScaleData(so_merged_raw, vars.to.regress = c("percent.mt", "nFeature_RNA"), assay = "RNA")
