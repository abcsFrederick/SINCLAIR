...
params:
  ...
  harmonyGroupObj: "/data/sevillas2/scRNA_test/batch_correct/group1-group2_batchcorrection_harmony.rds"
  resolution_list: "0.1,0.2,0.3,0.5,0.6,0.8,1"
  citeseq: "text"
  annot: "text"
  imageDir: "path/to/images"
  Rlib_dir: "/data/CCBR_Pipeliner/db/PipeDB/Rlibrary_4.3_scRNA_RHEL8"
  Rpkg_config: "/data/CCBR_Pipeliner/Pipelines/TechDev_scRNASeq_Dev2023/TechDev_scRNASeq_Dev2023_SC/conf/Rpack.config"
  scRNA_functions: "/data/CCBR_Pipeliner/Pipelines/TechDev_scRNASeq_Dev2023/TechDev_scRNASeq_Dev2023_SC/bin/scRNA_functions.R"
  testing: "Y"
geometry:
  margins:0.25in
editor_options: 
...
harmonyGroupObj=params$harmonyGroupObj
...
```{r removelibraryImport, message=FALSE, warning=FALSE}
...
objList = c("merged","CCAintegrated","harmony","rpca")
```

```{r removedataLoad, message=FALSE, warning=FALSE}
# set up params
# gid = params$gid
# mergedObj=params$mergedObj
...
# 
# # identify object list
# objList = c("merged","CCAintegrated","harmonyGroup","harmonySample","rpca")
```
