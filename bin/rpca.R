...
so <- IntegrateLayers(object = so, method = RPCAIntegration, normalization.method = "SCT", verbose = F,new.reduction = "RPCA")

so = runClustIntegrated(so,pcs,resolutions,"RPCA")
