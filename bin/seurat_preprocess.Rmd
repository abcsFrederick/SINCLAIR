...
# create S object
if (testing=="Y"){
  pbmc.data=Read10X(data.dir="/data/CCBR_Pipeliner/Pipelines/TechDev_scRNASeq_Dev2023/data_storage/10xFQ/filtered_gene_bc_matrices/hg19/")
...
# Process data
so_processed = MAIN_PROCESS_SO(so_qc, species, npcs_val)
