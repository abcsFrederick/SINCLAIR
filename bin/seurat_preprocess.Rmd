...
params:
  ...
  Rlib_dir: "CCBR_Pipeliner/db/PipeDB/Rlibrary_4.3_scRNA"
...
if (testing=="Y"){
  ...
  library_db_loc = paste0("~/../../Volumes/",Rlib_dir)
}else {
  library_db_loc = paste0("/data/",Rlib_dir)
}
print(paste0("Using the lib.loc location: ",library_db_loc))
...
for (rowid in rownames(pkg_df)){
  ...
  #   if (source=="cr") install.packages(pkg,version=version)
  #   if (source=="gh") remotes::install_github(gh_name,version=version)
  # }
