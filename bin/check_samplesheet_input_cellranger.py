...
def check_files(fileid):
    ...
    if sID == False:
        print_error("Input file must include filtered_feature_bc_matrix in name:", fileid)

    # spit after S1_L00
    ext=fileid.split("filtered_feature_bc_matrix")[1]

    if ext != ".h5":
        print_error("Input dir must include filtered_feature_bc_matrix.h5 in name:", ext)
...
def check_samplesheet(file_in_s, file_in_c, file_out):
    ...
    WB_Lysis_1,sample1,group1,gex,/data/CCBR_Pipeliner/Pipelines/TechDev_scRNASeq_Dev2023/test_dir/sample1/outs/
    WB_Lysis_1,sample2,group1,gex,/data/CCBR_Pipeliner/Pipelines/TechDev_scRNASeq_Dev2023/test_dir/sample2/outs/

    For an example see:
    https://github.com/CCBR/TechDev_scRNASeq_Dev2023/blob/dcd7f8e5b5ecabf48a3bb5b45ca73b8e0cde72c2/assets/input_manifest_cellranger.csv
