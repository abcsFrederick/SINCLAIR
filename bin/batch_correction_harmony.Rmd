...
params:
  gid: "group1_group2"
  mergedObj: "~/../../Volumes/data-1/scRNA_test/seurat/group1_group2.rds"
  species: "hg19"
...
# integrate
so_corrected <- MAIN_BATCH_CORRECTION(so,npcs,species,resolution,method_in=HarmonyIntegration,new.reduction_in = "harmony")
```

```{r saveoutputs, message=FALSE, include=FALSE, echo=FALSE}
fpath=paste0(gid,"_batchcorrection_harmony.rds")
