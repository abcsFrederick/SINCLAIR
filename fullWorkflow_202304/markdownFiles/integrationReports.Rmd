...
#### Cell type annotations before and after batch correction
...
for (res in resString) {
  ...
  clusterPlot <- DimPlot(merged,
    group.by = paste0("SLM_SCT_snn_res.", resMod), label = T, repel = T,
...
for (res in resString) {
  ...
  cat("  \n##### Clustering at Resolution ", res, " \n")
  clusterPlot <- DimPlot(integrated,
    group.by = paste0("SLM_int_snn_res.", resMod), label = T, repel = T,
...
for (res in resString) {
  ...
  cat("  \n##### Clustering at Resolution ", res, " \n")
  clusterPlot <- DimPlot(harmonyGroup,
    group.by = paste0("SLM_SCT_snn_res.", resMod), label = T, repel = T,
